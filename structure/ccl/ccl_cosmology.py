...
class CCLCosmologyManager:
    ...
    def compute_background_quantities(self, block: Any) -> None:
        ...
        # Distances
        d_C = ccl.comoving_radial_distance(self.cosmo_ccl, a)
        ...
        #d_V = ((1 + z)**2 * z * d_A**2 / (h_z*block.get_double(cosmo, "h")))**(1./3.)
        ...
        #block[distances, "rs_drag"] = ccl.sound_horizon(self.cosmo_ccl, a)
    ...
    def compute_growth_factors(self, block: Any) -> None:
        ...
        D_z = ccl.growth_factor(self.cosmo_ccl, a) #normalised to unity today
        #D_z_unnorm = ccl.growth_factor_unnorm(self.cosmo_ccl, a) #unnormalised 
    ...
    def compute_power_spectra(self, block: Any) -> None:
        ...
        sigma_8 = ccl.sigma8(self.cosmo_ccl)
